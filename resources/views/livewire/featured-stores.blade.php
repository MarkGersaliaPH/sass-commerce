        ...
        <div class="container">
          <div class="row h-100">
            <div class="col-lg-7 mx-auto text-center mb-6">
              <h5 class="fw-bold fs-3 fs-lg-5 lh-sm mb-3 text-danger">Featured Stores</h5>
            </div>
          </div>
          <div class="row gx-2 mx-auto d-flex justify-content-center">
            @foreach ($stores as $store)
                
            <div class="col-6 h-100 mb-5">
                <div class="card card-span h-100 text-white border rounded-3">
                  ...
                  <div class="card-body">
                    ...
                    </div><span class="badge bg-soft-success p-2"><span class="fw-bold fs-1 text-success">Opens Today</span></span>
                  </div>
                </div>
              </div> 
            @endforeach
