 <div class="card card-span rounded-3">
     ...
     <div class="card-body ps-0">
         ...
         <h6 class="text-muted   text-truncate mb-1">{{ $product->category->name }}</h6>

         <div class="d-flex justify-content-between">

             <div>
                 <span class="text-danger"><i class="fas fa-map-marker-alt"></i></span>
                 <span class="text-danger">{{ $product->store->address }}</span>
             </div> 
         </div>
