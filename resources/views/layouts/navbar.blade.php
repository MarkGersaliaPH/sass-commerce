<nav class="navbar navbar-expand-lg navbar-light bg-light bg-gradient fixed-top shadow" >
    <div class="container-fluid"><a class="navbar-brand d-inline-flex" href="/"><img class="d-inline-block"
        ...
        <div class="collapse navbar-collapse border-top border-lg-0 my-2 mt-lg-0" id="navbarSupportedContent">
            ...
            <a href="{{ route('filament.customer.auth.login') }}" class="btn btn-white text-warning rounded ms-auto"
