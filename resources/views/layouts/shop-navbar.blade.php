      ...
      <nav class="navbar navbar-expand-lg navbar-light shadow fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container-fluid"><a class="navbar-brand d-inline-flex" href="index.html"><img class="d-inline-block" src="{{asset("template/assets/img/gallery/logo.svg")}}" alt="logo" /><span class="text-1000 fs-3 fw-bold ms-2 text-gradient">foodwaGon</span></a>
